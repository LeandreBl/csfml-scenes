...
int lscene_create(lscene_t *scene, const char *name, uint32_t frame_per_sec) __THROW
	__nonnull((1, 2));
...
int lscene_get_objects_by_name(lscene_t *scene, gtab_t *empty_tab, const char *name) __THROW
	__nonnull((1, 2, 3));
int lscene_get_objects_by_tag(lscene_t *scene, gtab_t *empty_tab, int tag) __THROW
	__nonnull((1, 2));
int lscene_get_objects_by_type(lscene_t *scene, gtab_t *empty_tab,
			       enum lgameobject_type type) __THROW __nonnull((1, 2));
